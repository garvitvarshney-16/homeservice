  ...
  return (
    <View style={{ alignItems: 'center' }}>
      ...
      <View style={styles.subContainer}>
        ...
        <Text style={{ fontSize: 18, color: Colors.WHITE, textAlign: 'center', marginTop: 20 }}>Best App to fund services near you which deliver you a professional service</Text>
